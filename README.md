...
I have worked on academic projects where I developed REST APIs using Python and implemented a GraphQL API for data management.

I also have experience in software testing, applying testing strategies and TDD, and using tools like Postman to validate API functionality.
